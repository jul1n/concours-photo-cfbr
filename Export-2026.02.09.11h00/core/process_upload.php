            ...
            <div class="bg-white p-8 rounded-lg shadow-xl text-center">
                ...
                <div class="bg-orange-50 border-l-4 border-[#FF9900] p-6 text-left mb-8 rounded-r-lg">
                    ...
                    <p class="text-gray-700 mb-6">
                        Un email vient de vous être envoyé. Il contient un <strong>lien de validation</strong> unique pour confirmer votre signature.
                    </p>
                    <div class="pt-2">
                         <a href="../dossier.php?token=<?= $token ?>" class="inline-block text-[#0A2240] font-bold underline hover:text-[#FF9900]">
